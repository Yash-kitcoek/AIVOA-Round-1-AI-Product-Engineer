...
class Complaint(Base):
    ...
    manufacturing_date: Mapped[str] = mapped_column(String(100), default="")
    expiry_date: Mapped[str] = mapped_column(String(100), default="")
    originating_site: Mapped[str] = mapped_column(String(100), default="")
